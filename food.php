...
for($i = 1; $i <= $jumlah; $i++){
	$ch = curl_init();
	curl_setopt($ch, CURLOPT_URL, "http://scratch-cube.xyz/DC-FOOD/Dragoncityhax.php");
	...
	curl_setopt($ch, CURLOPT_REFERER, 'http://scratch-cube.xyz/DC-FOOD/Dragoncityhax.php');
	...
	curl_setopt($ch, CURLOPT_POSTFIELDS,"facebookID=".$fbid."&sessionID=".$sessionid."&externalID=".$fbid."&mode=food");
